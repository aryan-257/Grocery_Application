...
export const routes: Routes = [
  ...
  { path: 'offers',    loadComponent: () => import('./pages/offers/offers').then(m => m.OffersComponent), canActivate: [authGuard] },
  ...
  { path: 'orders/:id/rate',  loadComponent: () => import('./pages/rate-order/rate-order').then(m => m.RateOrder),         canActivate: [authGuard] },
